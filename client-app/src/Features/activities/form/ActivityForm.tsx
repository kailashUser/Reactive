...
import { categoryOptions } from '../../../app/api/common/form/option/CategoryOption';
...
export default observer(function ActivityForm(){
    ...
    const {createActivity,loading,loadActivity,loadingInitial,updateActivity }= activityStore;
...
const validationSchema = Yup.object({
    ...
    if(loadingInitial) return <LoadingComponent content='Create Activity...' />
